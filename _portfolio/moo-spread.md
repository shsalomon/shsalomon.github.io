...
excerpt: "SPREAD learns a conditional diffusion model over decision variables and then iteratively refines sampled candidates during reverse diffusion to move them toward Pareto-optimal regions.<br/><img src='/images/ZDT2_n200_online.gif'>"
